    ...
    <div className="">
      <div className="flex gap-[32px]">
        <div className="flex flex-col w-[70%]">
          ...
          <div className="text-[#09539D] text-[16px] font-[500] opacity-[0.8]">
            IGNITION-1
          </div>
          <div className="text-[#000] text-[16px] font-[400] leading-[150%] opacity-[0.8] mt-[24px]">
            <h1 className="text-[#1D1D1D] text-[24px] font-[500] leading-[125%] mb-[16px]">
              About
            </h1>
            {data?.about}
          </div>
      ...
      <div className="mt-[80px]">
        <h1 className="text-[#1D1D1D] text-[24px] font-[500] leading-[125%] mb-[10px]">
          Photos
        </h1>
