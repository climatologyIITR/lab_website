...
const Navbar = () => {
  ...
  return (
    <>
      <div className="py-[10px] lg:px-[80px] lg:flex hidden custom-shadow bg-white justify-between mx-auto  w-full fixed top-0">
        <div
        ...
        <div className="flex lg:gap-x-[55px] items-center my-auto">
          ...
          <Link href={"/reasearch"}>Research and Project</Link>
